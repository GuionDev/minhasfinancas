...
import com.anselmoguion.minhasfinancas.api.dto.AtualizaStatusDTO;
import com.anselmoguion.minhasfinancas.api.dto.LancamentoDTO;
...
import com.anselmoguion.minhasfinancas.model.enums.TipoLancamento;
...
public class LancamentoResource {
	...
	public ResponseEntity atualizarStatus( @PathVariable("id") Long id, @RequestBody AtualizaStatusDTO dto ) {
		return service.obterPorId(id).map( entity -> {
			...
			if(statusSelecionado == null) {
				return ResponseEntity.badRequest().body("Não foi possivel atualizar o status do lançamento, envie um status correto");
			}
			try {
	...
	public ResponseEntity buscar(
		...
		if(!usuario.isPresent()) {
			return ResponseEntity.badRequest().body("Não foi possivel realizar a consulta. Usuário não encontrado para consulta");
		} else {
	...
	private Lancamento converter(LancamentoDTO dto) {
		...
		System.out.println("=========== to antes da caralha do if r=========");
		...
		System.out.println("=========== lancamento resource.converter=========");
